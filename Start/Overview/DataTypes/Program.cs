...
Console.WriteLine($"{ 5 + 'A' }"); // -> 70. 'A' gets implicitly converted to its ASCII value, 65.

// Explicit type conversion
Console.WriteLine($"{(char)(5 + 'A')}"); // -> 'F'. This converts the 70 above into its ASCII char, 'F'.
